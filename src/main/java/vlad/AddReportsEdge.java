...
public class AddReportsEdge {
	private WebDriver fox;
	@BeforeTest
	
	public void setUp(){
		System.setProperty("webdriver.edge.driver", "C:/QA/Eclipse/Drivers/edgedriver/MicrosoftWebDriver.exe");
		fox = new EdgeDriver();
		fox.manage().timeouts().pageLoadTimeout(22, TimeUnit.SECONDS);
		fox.manage().timeouts().implicitlyWait(22, TimeUnit.SECONDS);
