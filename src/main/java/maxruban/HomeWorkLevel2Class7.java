...
public class HomeWorkLevel2Class7 {
	...
	public void createReport() throws InterruptedException {
		...
		suspect.put("DriverLicens", "R-0987654321");
		...
		suspect.put("Parend City", "Mountain View");
		...
		suspect.put("Oficer ID", "ABC 12345");
		...
		suspect.put("Vehicle Color", "2013");
		...
		String t = suspect.get("Other ID Type");
		...
		WebElement selectEmployersState = driver.findElement(By.xpath("//select[@ng-model='wizard.report.employerState']"));
		...
		WebElement selectvehicleState = driver.findElement(By.xpath("//select[@ng-model='wizard.report.vehicleState']"));
